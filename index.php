...
<head>
	...
	<meta name="author" content="Πασχαλέρης Τριαντάφυλλος">
...
<div id="wrap">
	<div id="content">
		<div id="menu">
			<ul id="menu_list">
				<li id="menu_item1"><div><a class="button" href="/shortlinks"><em>My goodies!</em></a></div></li>
		...
		<div id="achievements">
			...
			<ul id="ach_list">
					<li id="ach_item1" title="...feeling artistic"><div><span><?php statsCalc(21,"109"); ?></span> Multimedia Files Created</div></li>
					<li id="ach_item2" title="...keyboard abuse"><div><span><?php statsCalc(24,"5.2","K",true); ?></span> Lines Of Code Written</div></li>
					<li id="ach_item3" title="...yummy!"><div><span><?php statsCalc(20,"109"); ?></span> Sandwiches Tasted</div></li>
					<li id="ach_item4" title="...another cold drink? Yay!"><div><span><?php statsCalc(16,"81","L"); ?></span> Coffee & Beer Enjoyed</div></li>
					<li id="ach_item5" title="...relaxing time!"><div><span><?php statsCalc(64,"26"); ?></span> Games Played & TV Series Watched</div></li>
					<li id="ach_item6" title="Coursera, edX, MVA, Udemy"><div><span><?php statsCalc(19,"93","H"); ?></span> Spent on MOOCs</div></li>
		...
		<div id="contact">
			...
			<ul id="cont_list">
					<li id="cont_item1"><div><a href="http://gr.linkedin.com/in/mourgolikos" target="_blank"><img src="_images/social/set2/linkedin.png" alt="LinkedΙn" title="Triantafyllos Paschaleris LinkedΙn"></a></div></li>
